...
export function Sidebar() {
  ...
  const navigation = [
    ...
    { name: t('nav.declarations'), href: '/dashboard/declarations', icon: FileText },
    { name: t('nav.g50'), href: '/dashboard/g50', icon: FileCheck },
    { name: t('nav.tfpc'), href: '/dashboard/tfpc', icon: GraduationCap },
    { name: t('nav.dividends'), href: '/dashboard/dividends', icon: PiggyBank },
    { name: t('nav.foreignWithholding'), href: '/dashboard/foreign-withholding', icon: Globe },
    { name: t('annualTax.nav'), href: '/dashboard/annual-tax', icon: PieChart },
    { name: t('nav.myTeam'), href: '/dashboard/team', icon: Users, roles: ['ACCOUNTANT', 'ADMIN'] },
    { name: t('nav.myClients'), href: '/dashboard/accountant', icon: Briefcase, roles: ['ACCOUNTANT', 'ADMIN'] },
